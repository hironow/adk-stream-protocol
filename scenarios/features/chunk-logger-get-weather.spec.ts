/**
 * Chunk Logger Integration Tests - get_weather Tool
 *
 ...
 *
 * Tests get_weather tool (no approval required) = 1 test case
 *
...
const SESSION_ID =
  process.env.NEXT_PUBLIC_CHUNK_LOGGER_SESSION_ID || "e2e-get-weather";

test.describe
  .serial("Chunk Logger Integration - get_weather", () => {
    ...
    /**
     * Test 1: get_weather - Basic execution (no approval required)
     */
