...
describe('ImageDisplay', () => {
  describe('Basic Rendering', () => {
    it('should render image with correct data URL', () => {
      const content = 'iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVR42mNk+M9QDwADhgGAWjR9awAAAABJRU5ErkJggg==';
    ...
    it('should handle different media types', () => {
      ...
      testCases.forEach(({ mediaType, content }) => {
        const { unmount } = render(<ImageDisplay content={content} mediaType={mediaType} />);
  ...
  describe('Alt Text', () => {
    ...
    it('should use custom alt text when provided', () => {
      ...
      render(<ImageDisplay content="AAAA" mediaType="image/png" alt={customAlt} />);
