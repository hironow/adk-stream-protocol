        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "0.5rem" }}>
          <button
            ...
            style={{
              padding: "0.5rem 1rem",
              borderRadius: "4px",
              border: mode === "gemini" ? "2px solid #2563eb" : "1px solid #333",
          ...
          <button
            ...
            style={{
              padding: "0.5rem 1rem",
              borderRadius: "4px",
              border: mode === "adk-sse" ? "2px solid #10b981" : "1px solid #333",
          ...
          <button
            ...
            style={{
              padding: "0.5rem 1rem",
              borderRadius: "4px",
              border: mode === "adk-bidi" ? "2px solid #f59e0b" : "1px solid #333",
