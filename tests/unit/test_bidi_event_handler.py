...
# ============================================================
# Event Routing Tests (handle_event)
# ============================================================


@pytest.mark.asyncio
async def test_handle_event_routes_to_message_handler() -> None:
...
@pytest.mark.asyncio
async def test_handle_event_routes_to_audio_control_handler() -> None:
...
@pytest.mark.asyncio
async def test_handle_event_routes_to_audio_chunk_handler() -> None:
...
@pytest.mark.asyncio
async def test_handle_event_routes_to_tool_result_handler() -> None:
