...
describe("sendAutomaticallyWhen - Comprehensive False Cases", () => {
  ...
  describe("Cross-Mode Consistency", () => {
    it("BIDI and SSE return same result for identical input (approval-responded)", () => {
      const messages: UIMessageFromAISDKv6[] = [
        {
          id: "msg-cross-mode-approval-test",
          role: "assistant",
          content: "",
          parts: [
            {
              ...
              toolCallId: "call-cross-mode-1",
              approval: { id: "approval-cross-mode-1", approved: true },
            },
          ],
        } as any,
      ];
      ...
      // Both should return true (send approval to backend)
      expect(bidiResult).toBe(true);
    ...
    it("BIDI and SSE return same result for user message", () => {
      const messages: UIMessageFromAISDKv6[] = [
        { id: "msg-cross-mode-user-test", role: "user", content: "Test" },
      ];
