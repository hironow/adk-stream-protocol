...
| Date | Experiment | Status | Objective | Result |
|------|-----------|--------|-----------|--------|
| 2025-12-19 | [BIDI Confirmation ID Bug Fix](../docs/BUG-BIDI-CONFIRMATION-ID-MISMATCH.md) | ✅ **Complete - GREEN** | Fix BIDI multi-turn tool confirmation ID routing bug | ✅ **GREEN PHASE COMPLETE**: Fixed confirmation ID registration and context-aware lookup. Integration tests: 4/4 passing (RED → GREEN). Unit test: 1/1 passing. E2E tests: All passing. Bug fixed! Branch: `hironow/fix-confirm` |
...
| 2025-12-13 | [Bidirectional Protocol](./2025-12-13_bidirectional_protocol_investigation.md) | 🟡 Partial (Phase 1-3 Complete) | Align bidirectional protocol; Tool Approval Phase 4 | ⏳ Phase 4 pending; Phase 1-3 complete; see [agents/tasks.md](../agents/tasks.md#p2-t2) |
...
- **Missing tool-input events**: Fix confirmation flows for SSE/BIDI to emit original tool input events. See [agents/tasks.md](../agents/tasks.md#active-task-missing-tool-input-events-bug-fix).
...
- **P2-T2 Phase 4**: Complete Tool Approval alignment in bidirectional protocol. See [2025-12-13_bidirectional_protocol_investigation.md](./2025-12-13_bidirectional_protocol_investigation.md) and [agents/tasks.md](../agents/tasks.md#p2-t2).
